              ...
              <div class="py-12">
                ...
                <form>
                  <div class="flex gap-6">
                    <div class="md:w-1/2">
                      <div class="mb-5">
                        <label for="exampleInputName1" class="block text-sm font-medium mb-1 text-gray-600"
                    ...
                    <div class="md:w-1/2">
                      <div class="mb-5">
                        <label for="exampleInputName" class="block text-sm font-medium mb-1 text-gray-600"
                          >Name <span class="text-red-500">*</span></label
                        >
                        <input
                          type="text"
                  ...
                  <div class="w-full">
                    ...
                    <div class="mb-5">
                      <label for="exampleFormControlTextarea1" class="block text-sm font-medium mb-1 text-gray-600"
