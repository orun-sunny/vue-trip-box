            ...
            <ul class="navbar-nav flex gap-x-3 items-center justify-center">
              ...
              <li class="nav-item hs-dropdown relative inline-flex [--trigger:hover] [--placement:bottom]">
                <a
                  ...
                  class="hs-dropdown-toggle nav-link after:absolute hover:after:-bottom-10 after:inset-0"
                ...
                <div
                  ...
                  class="hs-dropdown-menu hs-dropdown-open:opacity-100 z-10 transition-[margin,opacity] duration-300 hidden opacity-0 mt-4 hs-dropdown-open:translate-y-0 translate-y-3 origin-center bg-white rounded-lg shadow-lg border p-2 w-96 grid grid-cols-2 gap-1.5"
                >
                  <div class="nav-item">
              ...
              <li class="nav-item hs-dropdown relative inline-flex [--trigger:hover]">
                ...
                <div
                  ...
                  class="hs-dropdown-menu hidden opacity-0 mt-4 hs-dropdown-open:opacity-100 origin-center bg-white rounded-lg shadow-lg border p-2 w-48 space-y-1.5"
                >
                  <!-- Dropdown item -->
                  <div class="nav-item hs-dropdown [--trigger:hover] [--placement:right-top]">
                    <a
                      class="nav-link after:absolute after:inset-0 hs-dropdown-toggle after:-end-10"
                      data-fc-offset="8"
                    ...
                    <div
                      class="hs-dropdown-menu ms-2 hidden w-48 opacity-0 hs-dropdown-open:opacity-100 translate-y-3 origin-center bg-white rounded-lg shadow-lg border p-2 space-y-1.5"
                    >
                      <div class="nav-item">
                  ...
                  <div class="nav-item hs-dropdown [--trigger:hover] [--placement:right-top]">
                    <a
                      class="hs-dropdown-toggle nav-link after:absolute after:inset-0 after:-end-10"
                      data-fc-offset="8"
                      data-fc-placement="right-start"
                      data-fc-trigger="hover"
                      data-fc-type="dropdown"
                    ...
                    <div
                      class="hs-dropdown-menu ms-2 hidden w-48 opacity-0 hs-dropdown-open:opacity-100 hs-dropdown-open:translate-y-0 translate-y-3 origin-center bg-white rounded-lg shadow-lg border p-2 space-y-1.5"
                    >
                      <div class="nav-item">
                  ...
                  <div class="nav-item hs-dropdown [--trigger:hover] [--placement:right-top]">
                    <a
                      class="nav-link after:absolute after:inset-0 after:-end-10 hs-dropdown-toggle"
                      data-fc-offset="8"
                      data-fc-placement="right-start"
                      data-fc-trigger="hover"
                      data-fc-type="dropdown"
      ...
      <div class="flex flex-col h-full divide-y-2 divide-gray-200">
        ...
        <div class="p-6 flex items-center justify-center">
          <a
            href="https://1.envato.market/prompt-tailwind"
            target="_blank"
            class="bg-primary w-full text-white p-3 rounded flex items-center justify-center text-sm"
            >Download</a
          >
        </div>
      </div>
