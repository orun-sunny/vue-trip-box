<template>
  <div>
    <!-- =========== Navbar Start =========== -->
    <header id="navbar"  class="link-color fixed top-0 inset-x-0 flex items-center z-40 w-full lg:bg-transparent bg-white transition-all py-5" :class=" isSticky && 'nav-sticky' || headerClass">
      <div class="container">
        <nav class="flex items-center">
          ...
          <div class="hidden lg:block ms-auto">
            <ul class="navbar-nav flex gap-x-3 items-center justify-center">
              ...
              <!-- Home Page Dropdown -->
              <li class="nav-item hs-dropdown relative inline-flex [--trigger:hover] [--placement:bottom]">
                <a href="javascript:void(0);" class="hs-dropdown-toggle nav-link after:absolute hover:after:-bottom-10 after:inset-0" data-fc-type="dropdown" data-fc-trigger="hover" data-fc-target="landingDropdownMenu" data-fc-placement="bottom">
                  Landing <i class="fa-solid fa-angle-down ms-2 align-middle"></i>
                </a>

                <div id="landingDropdownMenu" aria-labelledby="hs-dropdown" class="hs-dropdown-menu hs-dropdown-open:opacity-100 z-10 transition-[margin,opacity] duration-300 hidden opacity-0 mt-4  hs-dropdown-open:translate-y-0 translate-y-3 origin-center  bg-white rounded-lg shadow-lg border p-2 w-96 grid grid-cols-2 gap-1.5">
                  <div class="nav-item">
                    <NuxtLink class="nav-link" to="/landing/app">
              ...
              <li class="nav-item hs-dropdown relative inline-flex [--trigger:hover]">
                <a href="javascript:void(0);" class="hs-dropdown-toggle nav-link after:absolute hover:after:-bottom-10 after:inset-0">
                  Pages <i class="fa-solid fa-angle-down ms-2 align-middle"></i>
                </a>
                <div id="innerPageDropdownMenu" class="hs-dropdown-menu hidden opacity-0 mt-4 hs-dropdown-open:opacity-100 origin-center bg-white rounded-lg shadow-lg border p-2 w-48 space-y-1.5">
                  <!-- Dropdown item -->
                  <div class="nav-item hs-dropdown [--trigger:hover] [--placement:right-top]">
                    <a class="nav-link after:absolute after:inset-0 hs-dropdown-toggle after:-end-10" data-fc-offset="8" data-fc-placement="right-start" data-fc-trigger="hover" data-fc-type="dropdown" type="button">
                      Account <i class="fa-solid fa-angle-right ms-auto align-middle"></i>
                    </a>

                    <div class="hs-dropdown-menu ms-2 hidden w-48 opacity-0 hs-dropdown-open:opacity-100 translate-y-3 origin-center bg-white rounded-lg shadow-lg border p-2 space-y-1.5">
                      <div class="nav-item">
                        <NuxtLink class="nav-link" to="/pages/account-dashboard">Dashboard</NuxtLink>
                      </div>

                      <div class="nav-item">
                        <NuxtLink class="nav-link" to="/pages/account-setting">Settings</NuxtLink>
                      </div>

                      <div class="nav-item">
                        <NuxtLink class="nav-link" to="/pages/account-login">Login</NuxtLink>
                      </div>

                      <div class="nav-item">
                        <NuxtLink class="nav-link" href="/pages/account-signup">Sign Up</NuxtLink>
                      </div>

                      <div class="nav-item">
                        <NuxtLink class="nav-link" href="/pages/account-forget-password">Forget Password</NuxtLink>
                      </div>

                      <div class="nav-item">
                        <NuxtLink class="nav-link" to="/pages/account-confirm">Confirm Account</NuxtLink>
                      </div>
                    </div>
                  </div>
                  ...
                  <!-- Dropdown item -->
                  <div class="nav-item  hs-dropdown [--trigger:hover] [--placement:right-top]">
                    <a class="hs-dropdown-toggle nav-link after:absolute after:inset-0 after:-end-10" data-fc-offset="8" data-fc-placement="right-start" data-fc-trigger="hover" data-fc-type="dropdown" type="button">
                      Blog <i class="fa-solid fa-angle-right ms-auto align-middle"></i>
                    </a>

                    <div class="hs-dropdown-menu ms-2 hidden w-48 opacity-0 hs-dropdown-open:opacity-100 hs-dropdown-open:translate-y-0 translate-y-3 origin-center bg-white rounded-lg shadow-lg border p-2 space-y-1.5">
                      <div class="nav-item">
                        <NuxtLink class="nav-link" to="/blog/blog">Blog</NuxtLink>
                      </div>

                      <div class="nav-item">
                        <NuxtLink class="nav-link" to="/blog/blog-post">Blog Post</NuxtLink>
                      </div>
                    </div>
                  </div>
                  ...
                  <!-- Dropdown item -->
                  <div class="nav-item">
                    <NuxtLink class="nav-link" to="/pages/company">Company</NuxtLink>
                  </div>

                  <!-- Dropdown item -->
                  <div class="nav-item">
                    <NuxtLink class="nav-link" to="/pages/career">Career</NuxtLink>
                  </div>

                  <!-- Dropdown item -->
                  <div class="nav-item">
                    <NuxtLink class="nav-link" to="/pages/pricing">Pricing</NuxtLink>
                  </div>

                  <!-- Dropdown item -->
                  <div class="nav-item hs-dropdown [--trigger:hover] [--placement:right-top]">
                    <a class="nav-link after:absolute after:inset-0 after:-end-10 hs-dropdown-toggle" data-fc-offset="8" data-fc-placement="right-start" data-fc-trigger="hover" data-fc-type="dropdown" type="button">
                      Portfolio <i class="fa-solid fa-angle-right ms-auto align-middle"></i>
                    </a>

                    <div class="hs-dropdown-menu ms-2 hidden w-48 opacity-0 hs-dropdown-open:opacity-100 hs-dropdown-open:translate-y-0 translate-y-3 origin-center bg-white rounded-lg shadow-lg border p-2 space-y-1.5">
                      <div class="nav-item">
                        <NuxtLink class="nav-link" to="/portfolio/grid">Portfolio Grid</NuxtLink>
                      </div>

                      <div class="nav-item">
                        <NuxtLink class="nav-link" to="/portfolio/masonry">Portfolio Masonry</NuxtLink>
                      </div>

                      <div class="nav-item">
                        <NuxtLink class="nav-link" to="/portfolio/item">Portfolio Item</NuxtLink>
                      </div>
                    </div>
                  </div>
              ...
              <!-- Contact Page Link -->
              <li class="nav-item">
                <NuxtLink class="nav-link" to="/contact/contact-us">Contact us</NuxtLink>
              </li>
            </ul>
          </div>
    ...
    <div id="mobileMenu" class="hs-overlay hs-overlay-open:translate-x-0 hs-overlay-open:opacity-100 translate-x-full fixed top-0 end-0 transition-all duration-200 transform h-full w-full max-w-md z-[60] bg-white border-s hidden">
          ...
          <ul class="navbar-nav flex flex-col gap-2" data-fc-type="accordion">
            ...
            <li class="nav-item">
              <a href="javascript:void(0)" data-hs-collapse="#landing-collapse" class="hs-collapse-toggle nav-link">
                Landing <i class="fa-solid fa-angle-down ms-auto align-middle transition-all hs-collapse-open:rotate-180"></i>
              </a>

              <ul id="landing-collapse" class="hs-collapse hidden overflow-hidden transition-[height] duration-300 space-y-2">
            ...
            <!-- Inner Page -->
            <li class="nav-item">
              <a href="javascript:void(0)" data-hs-collapse="#pages-collapse" class="hs-collapse-toggle nav-link">
                Pages <i class="fa-solid fa-angle-down ms-auto align-middle transition-all hs-collapse-open:rotate-180"></i>
              </a>

              <ul id="pages-collapse" class="hs-collapse hidden overflow-hidden transition-[height] duration-300 space-y-2">
                <li class="nav-item mt-2">
                  <NuxtLink class="nav-link" to="/pages/company">Company</NuxtLink>
                </li>
            ...
            <!-- Blog Page -->
            <li class="nav-item">
              <a href="javascript:void(0)" data-hs-collapse="#blog-collapse" class="hs-collapse-toggle nav-link">
                Blog Page <i class="fa-solid fa-angle-down ms-auto align-middle transition-all hs-collapse-open:rotate-180"></i>
              </a>

              <ul id="blog-collapse" class="hs-collapse hidden overflow-hidden transition-[height] duration-300 space-y-2">
                <li class="nav-item mt-2">
                  <NuxtLink class="nav-link" to="/blog/blog">Blog</NuxtLink>
                </li>
            ...
            <!-- Portfolio Page -->
            <li class="nav-item">
              <a href="javascript:void(0)" data-hs-collapse="#portfolio-collapse" class="hs-collapse-toggle nav-link">
                Portfolio <i class="fa-solid fa-angle-down ms-auto align-middle transition-all hs-collapse-open:rotate-180"></i>
              </a>

              <ul id="portfolio-collapse" class="hs-collapse hidden overflow-hidden transition-[height] duration-300 space-y-2">
                <li class="nav-item mt-2">
                  <NuxtLink class="nav-link" to="/portfolio/grid">Portfolio Grid</NuxtLink>
                </li>
            ...
            <!-- Auth Page -->
            <li class="nav-item">
              <a href="javascript:void(0)" data-hs-collapse="#account-collapse" class="hs-collapse-toggle nav-link">
                Account <i class="fa-solid fa-angle-down ms-auto align-middle transition-all hs-collapse-open:rotate-180"></i>
              </a>

              <ul id="account-collapse" class="hs-collapse hidden overflow-hidden transition-[height] duration-300 space-y-2">
                <li class="nav-item mt-2">
                  <NuxtLink class="nav-link" to="/pages/account-login">Login</NuxtLink>
                </li>

                <li class="nav-item">
                  <NuxtLink class="nav-link" to="/pages/account-signup">Sign Up</NuxtLink>
                </li>

                <li class="nav-item">
                  <NuxtLink class="nav-link" to="/pages/account-forget-password">Forget Password</NuxtLink>
                </li>
...
onMounted(() => {
  window.addEventListener("scroll", (ev) => {
    ev.preventDefault();
    isSticky.value = document.body.scrollTop >= 75 || document.documentElement.scrollTop >= 75;
  });
...
function initTopnav() {
  ...
  const navbarLinks = Array.from(document.querySelectorAll('#navbar .navbar-nav a')) as HTMLAnchorElement[];
